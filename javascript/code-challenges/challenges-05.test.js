...
const addValues = (arr) => {
  // Solution code here...
//   let added = arr.reduce( (addnum, num) => {
//    addnum = addnum + num;
//    return addnum;
//   }, 0);
//   return added;
// };
  return arr.reduce(( addnum, num ) => { addnum = num + addnum; return addnum;}, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce(( addnum, num ) => { addnum = num.purchasePrice + addnum; return addnum;}, 0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce( addnum => { addnum = 1 + addnum; return addnum;}, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce(( addname, value, i) => { addname[i] = value.name; return addname;}, []);
};
...
//   return splitStrings.reduce(( acc, str ) => {return str + acc;}, '');
// };
  // let splitStrings = str.split('');
