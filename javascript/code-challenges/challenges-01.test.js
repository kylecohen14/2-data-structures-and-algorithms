...
const allUpperCase = (arr) => {
  // Solution code here...
  let newArr = []
  arr.forEach(num => newArr.push(num.toUpperCase()));
  return(newArr);
};
...
const greeting = (word) => {
  // Solution code here...
  let upperGreet = word.toUpperCase() + '!';
  return upperGreet;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let callbackArr = []
  words.forEach(element =>{let strings = callback(element);
  callbackArr.push(strings);
});
return callbackArr;
};
